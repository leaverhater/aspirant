...
<%
    ...
    try {
        ...
        prop.setProperty("expert", expert);

        //save properties to project root folder
        prop.store(new FileOutputStream("/home/vadya/content3.properties"), null);
...
<h5><span class="g-bold">Образовательная часть индивидуального плана работы аспиранта на календарный период от 20.10.2013 до 20.02.2015</span></h5>
