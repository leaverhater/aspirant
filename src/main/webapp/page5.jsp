...
//        save properties to project root folder
        prop.store(new FileOutputStream("/home/vadya/content4.properties"), null);
...
//    ZipIt.createDocx();
%>
<h5><span class="g-bold">Образовательная часть индивидуального плана работы аспиранта на календарный период от 20.02.2015 до 20.02.2016</span></h5>
<form method="post" action="page6.jsp">
    <table class="default" >
        <tbody id="table">
        <tr class="title">
            <td>Индекс</td>
